...
data_ts$author[1] <- "Crippa, et.al., 2008"
data_ts$author[2] <- "Yamao, K., et al., 2011"
data_ts$author[3] <-"Gil, E., et al., 2012"
data_ts$author[5] <- "Keane., et al., 2018"
data_ts$author[4] <- "Jang, K. T., et al., 2015"


x1 <- data_ts$mean_post1[2] #Error in extraction data of Yamao, K., et al., paper 
x2 <- data_ts$sd_post1[2]  
data_ts$mean_post1[2] <- data_ts$mean_post2[2] 
data_ts$sd_post1[2] <- data_ts$sd_post2[2] 
data_ts$mean_post2[2] <- x1
data_ts$sd_post2[2] <- x2
data_ts$mean_post1 <- as.numeric(data_ts$mean_post1)
data_ts$sd_post1 <- as.numeric(data_ts$sd_post1)
...
<br>
```{r dic_graph, echo=FALSE, fig.height=6.9, fig.width=14.7, message=FALSE, warning=FALSE}
...
```{r cont_graph, echo=FALSE, fig.height=3.3, fig.width=14.9, message=FALSE, warning=FALSE}
